...
function createSpinner(size = 100, loadingSpinner = '유저 정보 가져오는중...') {
  return `
  ...
  <figcaption>${loadingSpinner}</figcaption>
</figure>
  `;
}

function createEmptyCard(size = 200, errorMessage = '알 수 없는 오류 발생') {
  return `
